Вы можете создать новый ключ SSH на локальном компьютере 
...
Добавьте ключ SSH в учетную запись GitHub. 

Клонирование репозитория
На GitHub.com перейдите на главную страницу репозитория. 
1. Над списком файлов щелкните <>Код.
Скопируйте URL-адрес репозитория.
Клонировать репозиторий по протоколу HTTPS, в разделе "HTTPS" щелкните .
Клонировать репозиторий с помощью ключа SSH, включая сертификат, выданный центром сертификации SSH вашей организации
Чтобы клонировать репозиторий с помощью GitHub CLI
$ git clone https://github.com/YOUR-USERNAME/YOUR-REPOSITORY
2. Нажмите клавишу **ВВОД**, чтобы создать локальный клон.
$ git clone https://github.com/YOUR-USERNAME/YOUR-REPOSITORY
